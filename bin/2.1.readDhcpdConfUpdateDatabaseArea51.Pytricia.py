...
# If this was parsed the /28 will be overwritten by the /23
# First let's try create a list which contains SharedNetwork,Subnet
...
for line in  networkList:
	...
	## Write the network ID and broadbast address to database
...
## CM 180831 There is no need to parse the classes info. We already know what is static from above code
